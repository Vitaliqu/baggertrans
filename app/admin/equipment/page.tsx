                ...
                {filtered.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center hidden lg:table-cell">
                      {item.featured && (
                        <Star size={16} className="text-yellow-500 inline" fill="currentColor" />
                      )}
                    </td>
                    <td className="px-4 py-3">
          ...
          <div className="px-6 pb-6 pt-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-10 rounded-md bg-[var(--color-destructive)] text-white text-sm font-medium hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors"
              >
